...
export default function NftCreator({ contractAddress, abi }) {
	...
	const [NFTAttributes, setNFTAttributes] = useState([{ trait_type: '', value: '' }]);
	...
	return (
		...
		<div className={styles.page_flexBox}>
			<div
				...
				className={!txHash ? styles.page_container : styles.page_container_submitted}
			>
				<div className={styles.dropzone_container} {...getRootProps()}>
					<input {...getInputProps()}></input>
					{/* Check if an image is uploaded and display it */}
					{imageURL ? (
						<img alt={'NFT Image'} className={styles.nft_image} src={imageURL} />
					) : isDragActive ? (
									...
									<div key={index} className={styles.attributes_container}>
										<div className={styles.attributes_input_container}>
											<div className={styles.attribute_input_group}>
												...
												<h3 className={styles.attribute_input_label}>ATTRIBUTE NAME</h3>
												<input
											...
											<div className={styles.attribute_input_group}>
												...
												<h3 className={styles.attribute_input_label}>ATTRIBUTE VALUE</h3>
												<input
													className={styles.attribute_input}
					...
					<div>
						{isDisconnected ? (
							...
							<div>
								<button
									className={
										isSubmitting ? styles.submit_button_submitting : styles.submit_button
									}
